...
import 'package:first/core/services/services_locator.dart';
...
import 'package:first/movies/presentation/screens/dummy.dart';
...
class MovieDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context)=>sl<MovieDetailBloc>()..add(
                      ...
                      child: ShaderMask(
                        ...
                        child: CachedNetworkImage(
                          width: MediaQuery
                              ...
                              .size
                              .width,
                          imageUrl: ApiConstance.imageUrl(state.movieDetail!
                              .image),
                          fit: BoxFit.cover,
                        ),
                      ),
